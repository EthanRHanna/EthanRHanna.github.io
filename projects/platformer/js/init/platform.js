(function (window) {
    ...
    platform.init = function (game) {
        ...
        platform.create(0,535,2,.55); //Bottom long
        platform.create(0,250,.6,.55); // 2nd Top Left
        platform.create(0,100,.6,.55); //1st Top Left
        platform.create(300,200,.025,10); //Left Vertical Wall
         platform.create(300,200,.025,10);
